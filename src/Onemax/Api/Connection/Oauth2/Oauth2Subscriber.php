<?php
namespace Onemax\Api\Connection\Oauth2;

use Onemax\Api\Connection\Oauth2\GrantType\GrantTypeInterface;
use Onemax\Api\Connection\Oauth2\GrantType\RefreshTokenGrantTypeInterface;
